...
app.post("/", function (req, res) {
    ...
    if (listName === day) {
        ...
        Mylist.findOne({ name: listName }, function (err, foundList) {
...
app.post('/delete', function (req, res) {
    ...
    if (listName === day) {
        ...
        Mylist.findOneAndUpdate({name:listName},{$pull: {items: {_id:checkedItemId}}}, function (err, foundList) {
            if(!err){
                res.redirect('/'+listName);
            }
        });
...
app.get('/:varUrl', function (req, res) {
    ...
    Mylist.findOne({ name: varUrl }, function (err, foundList) {
        if (!foundList) {
            ...
            res.render('list', { listTitle: varUrl, newListItems: foundList.items });
        }
